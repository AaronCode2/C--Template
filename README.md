...
```
git clone https://github.com/AaronCode2/C--Template.git
```

### The Zipper Way

1. Hopefully you know how to install stuff from your browser  
2. Click on this [link](https://github.com/AaronCode2/C--Template/archive/refs/heads/main.zip) to download  
